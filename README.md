This script translates terminologies used in MS products by sending a SOAP request to api.terminology.microsoft.com/terminology and extracting the result
